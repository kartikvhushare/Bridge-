...
function adminDash(){
  ...
  if(can('surveys','create')||can('surveys','close')){const n=(DB.surveys||[]).filter(s=>s.status==='Active').length;t.push(['Surveys running',n,'surveys','msg','var(--c-surface-2)','var(--c-text-2)','surveys']);}
