...
const HOW={
  ...
  payroll:{t:'Reads the month automatically: clock-ins = paid days, unpaid leave & absence = deducted, approved overtime = added at its legal rate, disciplinary fines deducted. You verify → HoP approves → Finalize creates payslips + the bank file.',d:['A WPS chip shows the pay-by-1st deadline (Res 340/2026) and whether the run was paid on time or late.','Fines follow Art 25/39 caps: ≤5 days\' wage/month and never past 50% of the wage; shown as a separate payslip line.','Exit flows put people on HOLD — greyed, excluded from the bank file. Variance compares each net to last month; rollback restarts a run.'],l:[['attendance','Attendance'],['leave','Leave'],['overtime','Overtime'],['users','Users']]},
